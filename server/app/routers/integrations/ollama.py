...
from app.schemas import OllamaJobspecRequest, OllamaModelsResponse, genericResponse
...
@router.post(conf_pathname()+"/v1/external/ollama/check-jobspec", response_model=genericResponse)
def check_jobspec_endpoint(jobspec: OllamaJobspecRequest, session: Session = Depends(get_session)) -> genericResponse:
...
@router.post(conf_pathname()+"/v1/external/ollama/check-jobspec-profile", response_model=genericResponse)
def check_jobspec_profile_endpoint(jobspec: OllamaJobspecRequest, session: Session = Depends(get_session)) -> genericResponse:
...
@router.post(conf_pathname()+"/v1/external/ollama/get-coverletter", response_model=genericResponse)
def get_coverletter_endpoint(jobspec: OllamaJobspecRequest, session: Session = Depends(get_session)) -> genericResponse:
