...
@router.get(conf_pathname()+"/v1/roles/lnk/jobspec-tag-byjobspec/{jobspec_id}", response_model=list[LnkJobSpecTagBase])
...
@router.get(conf_pathname()+"/v1/roles/lnk/jobspec-tags-bytag/{tag_id}", response_model=list[LnkJobSpecTagBase])
